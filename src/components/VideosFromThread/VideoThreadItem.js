...
import { SCREEN_HEIGHT, SCREEN_WIDTH, permission } from "../../constants";
...
class VideoThreadItem extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    ...
    if (
      threadWatchingController.playingId === video.id &&
      threadWatchingController.isPlaying
    )
      this._videoRef.play();
      ...
      >
        <View style={styles.infoListItem}>
          <Image
            ...
            source={{ uri: video.page.avatar_url }}
          />
                  ...
                  <View style={styles.optionItemWrapper}>
                    ...
                    <View>
                      <Text style={styles.optionText}>
                        Hide {video.page.name}
                      </Text>
                      <Text style={{ ...styles.optionText, fontSize: 10 }}>
                        Hide this page in 30 days
                      </Text>
                    </View>
                  </View>
                </TouchableOpacity>
...
const mapDispatchToProps = (dispatch, props) => {
  return {
    pushThreadHeightMap: (videoId, height) =>
      dispatch(PushThreadHeightMap(videoId, height)),
  };
};
