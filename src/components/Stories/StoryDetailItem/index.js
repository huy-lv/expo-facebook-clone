...
class index extends Component {
  ...
  componentDidMount() {
    ...
    if (displayImagePosition == storyDetail.images.length)
  ...
  render() {
    ...
    return (
      <GestureRecognizer
        config={config}
        onSwipeRight={this.onSwipeHorizontalHandler.bind(this)}
        onSwipeLeft={this.onSwipeHorizontalHandler.bind(this)}
      >
        <ImageBackground
          blurRadius={50}
          imageStyle={{ resizeMode: "cover" }}
          style={styles.backgroundWrapper}
          source={{ uri: this.state.displayImage.url }}
        >
          <View>
            ...
            <View style={styles.userWrapper}>
              <TouchableOpacity
                onPress={this.onPressGoBackHandle.bind(this)}
              ...
              <View style={styles.userInfoWrapper}>
                ...
                <Text style={styles.time}>
                  {this.state.displayImage.create_at}
                </Text>
              </View>
            </View>
            <Image
