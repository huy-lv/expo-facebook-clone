      ...
      <View style={styles.container}>
        ...
        <View style={styles.navigationBar}>
          <ExTouchableOpacity
            ...
            style={{
              ...styles.btnBack,
              backgroundColor: this.state.isOverLimitY ? "#ddd" : "#fff",
            }}
          >
            <FontAwesome5Icon name="arrow-left" size={16} />
          </ExTouchableOpacity>
          <Animated.View
            style={{ ...styles.hiddenTitle, opacity: this._titleOpacity }}
          >
        ...
        >
          ...
          <View style={styles.infoWrapper}>
            <View>
              ...
              >
                Posted at {item.create_at} in {item.sell_in}
              </Text>
            </View>
            <View style={styles.messengerBox}>
              ...
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                <TextInput
                  value="Is this item still available?"
            ...
            <View style={styles.optionsWrapper}>
              <TouchableOpacity style={styles.btnOption}>
                <View style={styles.optionIcon}>
                  <FontAwesome5Icon name="facebook-messenger" size={24} />
                </View>
                <Text style={{ fontWeight: "bold" }}>Message</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.btnOption}>
                <View style={styles.optionIcon}>
                  <FontAwesome5Icon name="bookmark" size={24} />
                </View>
                <Text style={{ fontWeight: "bold" }}>Save</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.btnOption}>
                <View style={styles.optionIcon}>
                  <FontAwesome5Icon name="share" size={24} />
                </View>
                <Text style={{ fontWeight: "bold" }}>Share</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.btnOption}>
                <View style={styles.optionIcon}>
                  <FontAwesome5Icon name="ellipsis-h" size={24} />
                </View>
            ...
            <View style={styles.userInfoWrapper}>
              ...
              >
                ...
                <ExTouchableOpacity
                  onPress={this.onPressViewProfileHandler.bind(this)}
                >
                  <Text
                    style={{
                      color: "#318bfb",
            ...
            >
              ...
              >
                <View style={{ width: 20 }}>
                  <FontAwesome5Icon name="briefcase" color="#333" size={16} />
                </View>
                <Text
                  style={{
                    marginLeft: 10,
            ...
            <View style={styles.relatedGroupsWrapper}>
              ...
              {item.relatedGroups.map((group, index) => (
                <ExTouchableOpacity
                  onPress={this.onPressViewGroupDetailHandler.bind(
                    null,
                    group.id
                  )}
                  key={index}
                  style={styles.relatedGroupItem}
                >
                  <Image
